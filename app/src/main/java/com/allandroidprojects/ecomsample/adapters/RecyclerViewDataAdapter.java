...
public class RecyclerViewDataAdapter extends RecyclerView.Adapter<RecyclerViewDataAdapter.ItemRowHolder> {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_section, null);
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        SimpleStringRecyclerViewAdapter itemListDataAdapter = new SimpleStringRecyclerViewAdapter(itemRowHolder.recycler_view_list, singleSectionItems);
